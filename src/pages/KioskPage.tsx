...
export function KioskPage() {
  ...
  if (assignedToken) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-background px-4 bg-[radial-gradient(circle_at_50%_50%,rgba(20,184,166,0.1),transparent_50%)]">
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4 bg-[radial-gradient(circle_at_20%_20%,rgba(20,184,166,0.1),transparent_40%),radial-gradient(circle_at_80%_80%,rgba(14,165,233,0.1),transparent_40%)]">
      <div className="mb-8 flex flex-col items-center justify-center text-center">
        <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-white shadow-panel text-primary border border-primary/10">
